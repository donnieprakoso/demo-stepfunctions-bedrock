...
class CdkStack(Stack):
    def __init__(self, scope: Construct, id: str, stack_prefix: str,
        ...
        workflow = _sfn.StateMachine(self, "{}-state-machine".format(stack_prefix),
            ...
            definition_substitutions={"lambda_arn":function_process.function_arn},
            timeout=core.Duration.minutes(5),
            comment="StepFunctions integration with bedrock: Demo-3-parallel"
        )
...
stack_prefix = 'demo-stepfunctions-bedrock-3-parallel'
app = core.App()
